...
@interface ChartViewController ()<UITableViewDataSource,UITableViewDelegate,KeyBordVIewDelegate,ChartCellDelegate,AVAudioPlayerDelegate>
...
- (void)viewDidLoad
{
    ...
    [button setTitle: @"聊天室" forState: UIControlStateNormal];
    ...
    [backButton setBackgroundImage:[UIImage imageNamed:@"btn_Health_Profile_BloodPress_sel.png"] forState:UIControlStateNormal];
    [backButton addTarget:self action:@selector(selectbackAction:) forControlEvents:UIControlEventTouchUpInside];
