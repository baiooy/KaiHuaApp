...
@implementation Collect_Cell_Head_Rate
...
-(void) setHeatRateLayout{
    ...
    EPieChartDataModel *ePieChartDataModel = [[EPieChartDataModel alloc] initWithBudget:120 current:90 estimate:0 itemUnit:@"次/60S" itemType:@"心率值" itemColor:E_Head_hert_Color];
    ...
    _ePieChart.frontPie.currentColor = E_Head_hert_Color;
