...
@implementation Collect_Cell_Pedometer
...
-(void) setPedometerLayout{
    ...
    EPieChartDataModel *ePieChartDataModel = [[EPieChartDataModel alloc] initWithBudget:10 current:8 estimate:0 itemUnit:@"步/1h" itemType:@"计步数" itemColor:E_pedometer_Color];
    ...
    _ePieChart.frontPie.currentColor = E_pedometer_Color;
