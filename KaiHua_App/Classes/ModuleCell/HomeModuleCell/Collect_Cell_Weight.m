...
@implementation Collect_Cell_Weight
...
-(void) setWeightLayout{
    ...
    EPieChartDataModel *ePieChartDataModel = [[EPieChartDataModel alloc] initWithBudget:150 current:100 estimate:0 itemUnit:@"Kg" itemType:@"体重值" itemColor:E_Weight_Color];
    ...
    _ePieChart.frontPie.currentColor = E_Weight_Color;
