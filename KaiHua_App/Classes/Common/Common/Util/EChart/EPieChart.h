...
- (void) addNewItemValueIn:(EPieChart *) epicChart;
...
@property (strong, nonatomic) UIButton *addItemBtn;
...
@property (nonatomic,strong) UIColor *curentColor;
