...
@interface HMSegmentedControl : UIView

@property (nonatomic, strong) NSArray *sectionTitles;
@property (nonatomic, strong) void (^indexChangeBlock)(NSUInteger index); // you can also use addTarget:action:forControlEvents:
